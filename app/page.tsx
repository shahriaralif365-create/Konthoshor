...
export default function Home() {
  const [language, setLanguage] = useState<Language | string>('bengali');
  ...
  return (
    ...
    >
      ...
      <nav className="shrink-0 w-full z-50 glass-morphism border-b border-white/5 backdrop-blur-md" dir="ltr">
