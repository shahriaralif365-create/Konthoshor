...
export function PunctuationGuide({ language, onClose }: PunctuationGuideProps) {
  ...
  const guides: Record<string, { title: string; subtitle: string; items: GuideItem[] }> = {
    bengali: {
      ...
      items: [
        ...
        { command: 'বিস্ময়বোধক চিহ্ন দাও', result: '!', description: 'আবেগ প্রকাশে "বিস্ময়বোধক চিহ্ন দাও" বা "বিস্ময়বোধক চিহ্ন" বলুন।' },
      ]
    },
    english: {
  ...
  const currentGuide = guides[translationKey] || guides.english;
